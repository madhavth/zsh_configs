...
#auto-notify
plugins=(git zsh-autosuggestions zsh-completions zsh-z zsh-syntax-highlighting history-substring-search extract k fzf fd)
...
for file in /mnt/win/alias/*; do
  if [[ -f $file ]]; then
    source "$file"
  fi
done

AUTO_NOTIFY_IGNORE+=("sleep" "batcat" "git" "du")
#neofetch
...
function jskeyvalue()
{
 eval $(echo $* | jq -r "to_entries|map(\"\(.key)=\(.value|tostring)\")|.[]")
}
...
export ssr="http://localhost:8050/render.html"
alias srcconda="source /home/madhavth/.conda_config"
# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
#__conda_setup="$('/home/madhavth/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
#if [ $? -eq 0 ]; then
#    eval "$__conda_setup"
#else
#    if [ -f "/home/madhavth/miniconda3/etc/profile.d/conda.sh" ]; then
#        . "/home/madhavth/miniconda3/etc/profile.d/conda.sh"
#    else
#        export PATH="/home/madhavth/miniconda3/bin:$PATH"
#    fi
#fi
#unset __conda_setup
# <<< conda initialize <<<
export PATH="$PATH:/mnt/sdb2/depot_tools:/home/madhavth/scripts/bin"
export CHROMIUM_ANDROID="/mnt/sdb3/Chromium/src"
...
## Generated 2022-03-28 16:37:50.126360Z
## By /home/madhavth/flutter/bin/cache/flutter_tools.snapshot% 
...
alias nanoalias="nvim ~/.aliases && source ~/.aliases"
export PATH="$PATH:/mnt/win/android_linux/studio/android-studio/jre/bin"
export ANDROID_SDK_ROOT="/mnt/win/android_linux/Sdk"
